...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" placeholder="请输入4位纯数字班级名" autocomplete="off" class="layui-input" style="width: 240px;">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">辅导员姓名:</label>
                    <div class="layui-input-inline">
                        <input type="text" id="counsellorName" name="counsellorName" placeholder="请输入姓名" autocomplete="off" class="layui-input" style="width: 240px;">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">辅导员手机:</label>
                    <div class="layui-input-inline">
                        <input type="text" id="counsellorPhone" name="counsellorPhone" placeholder="请输入手机号码" autocomplete="off" class="layui-input" style="width: 240px;">
                    </div>
                </div>
                <div class="layui-inline">
                    <div class="layui-input-block">
        ...
        <table class="layui-hide" id="studentClassTable" lay-filter="studentClassTable"></table>
        ...
        <script>
            layui.use(['table','form'], function(){
                ...
                let form = layui.form;
                table.render({
                    elem: '#studentClassTable'
                    ,url:'/studentClass/all'
                    ,method: 'post'
                    ,request: {
                        pageName: 'startPage'
                        ,limitName: 'pageSize'
                ...
                //监听单元格编辑事件
                table.on('edit(studentClassTable)',function (obj){
                    //获取修改前的值，以便重新赋值
                ...
                //监听工具条事件
                table.on('tool(studentClassTable)',function (obj){
                    ...
                    if(layEvent === 'edit'){ //编辑
                        ...
                        let oldMajor = data.major;
                        let oldName = data.name;
                        layer.confirm('确认删除 '+oldMajor+' '+oldName+'班 的班级信息吗?', function(index){
                            //向服务端发送删除指令
                ...
                let $ = layui.$,active = {
                    reload:function (){
                        let major = $('#major');
                        let name = $('#name');
                        let counsellorName = $('#counsellorName');
                        let counsellorPhone = $('#counsellorPhone');
                        let index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:1000,shade:0.8});
                        //执行重载
                        table.reload('studentClassTable',{
                            page: {
                                curr: 1
                            },
                            method: "post",
                            contentType: "application/json",
                            url: "/studentClass/get",
                            where: {
                                major: major.val(),
                                name: name.val(),
                                counsellorName: counsellorName.val(),
                                counsellorPhone: counsellorPhone.val()
                            }
                        },'data');
                    }
                };
