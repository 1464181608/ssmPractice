            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;">新增房间</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <div class="layui-body">
        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="bedNumber" name="bedNumber" required lay-verify="required" lay-filter="bedNumber" placeholder="请输入床位号" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">学生学号</label>
                <div class="layui-input-inline">
                    <input type="text" id="id" name="id" required lay-verify="required" lay-filter="id" placeholder="请输入学生学号" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
        ...
        <script>
            layui.use('form', function(){
                ...
                form.on('select(building)', function(data){
                    ...
                    if($('#floor').val()!=""){
                        $.ajax({
                            url:'/roomIn/getNextRoomAndBedNumber',
                            type:'post',
                            ...
                            success:function(data){
                                ...
                                console.log(d);
                                if(d["msg"]==""){
                                    document.getElementById('number').value=d["data"][0];
                                    document.getElementById('bedNumber').value=d["data"][1];
                                    form.render('input','number');//菜单渲染 把内容加载进去
                                    form.render('input','bedNumber');
                                }else{
